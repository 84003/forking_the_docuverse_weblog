...
In designing Zoomed-In View, one of the challenges is indicating that there are multiple aliases of the same document. Below are variations of applying a color code.
...
The [next entry](13) reflects on the potential of the link types developed so far.
