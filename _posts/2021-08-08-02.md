...
In other words, the docuverse is a construct in which documents live, understood as a metadocument with all the information about documents' contents and linkages, including their version history. The concepts and implementations of Nelson's vision of the docuverse (among other historical examples of systems based on accommodating interconnection) are examined in the [next entry](03).
